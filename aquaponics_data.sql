insert into aquatic_organisms (name) values ('Tilapia');
...
insert into aqx_techniques (name) values ('Floating Raft');
insert into aqx_techniques (name) values ('Vertical Flow Through');
